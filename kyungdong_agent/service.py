...
class ManufacturingAgent:
    def __init__(self, client: Any, model: str = DEFAULT_MODEL, factory_tools: KyungdongToolRegistry | None = None) -> None:
        self.client = client
        self.model = model
        self.factory_tools = factory_tools

    def create_knowledge_base(self, name: str = "경동글로벌텍 제조 지식베이스") -> str:
